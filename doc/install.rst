...
:Tar-file:
    ...
    latest stable release (ase-3.23.tar.gz_) or the latest
    development snapshot (`<snapshot.tar.gz>`_).

    Unpack and make a soft link::

        $ tar -xf ase-3.23.tar.gz
        $ ln -s ase-3.23 ase
...
:Git clone:
    ...
    https://gitlab.com/ase/ase like this::
        ...
        $ git clone -b 3.23 https://gitlab.com/ase/ase.git
...
.. _ase-3.23.tar.gz: https://pypi.org/packages/source/a/ase/ase-3.23.tar.gz
