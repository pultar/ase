...
per_config_properties = [
    ...
    if not (isinstance(val, ArrayProperty) and val.shapespec[0] == "natoms")
]
    ...
    for key in dct:
        ...
        if val is not None and not isinstance(val, str):
            ...
            try:
                ...
                warnings.warn("Skipping unhashable information " "{}".format(key))
                continue
...
def save_calc_results(
    atoms, calc=None, calc_prefix=None, remove_atoms_calc=False, force=False
):
