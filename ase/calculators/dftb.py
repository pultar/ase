...
class Dftb(FileIOCalculator):
    ...
    fileio_rules = FileIOCalculator.ruleset(
        configspec=dict(skt_path=None), stdout_name='{prefix}.out'
    )
    ...
    def write_dftb_in(self, outfile):
        ...
        for key, value in sorted(params.items()):
            ...
            for my_backslash in reversed(range(previous_depth - current_depth)):
    ...
    def write_input(self, atoms, properties=None, system_changes=None):
        ...
        write(
            os.path.join(self.directory, 'geo_end.gen'), atoms, parallel=False
        )
    ...
    def read_eigenvalues(self):
        ...
        N = nkpt * nband
        eigenvalues = [
            eig[i * N : (i + 1) * N].reshape((nkpt, nband))
